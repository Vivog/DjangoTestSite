...
import os
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-%%p0*vzt#8oszp$=wm^5ew@adi7gggwx#1427max%65_r!l5%q')
# SECRET_KEY = 'django-insecure-%%p0*vzt#8oszp$=wm^5ew@adi7gggwx#1427max%65_r!l5%q'
